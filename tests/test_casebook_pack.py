"""Regression checks for the ledger-move-opening-lab casebook."""
...
from casebook.harness import assert_expected, ledger_move_opening_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ledger_move_opening_lab_summary(), assert_expected())
